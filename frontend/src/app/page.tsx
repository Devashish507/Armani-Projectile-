 ...
 *
 * Polls the backend /health endpoint every 10 s and displays a live
 * connectivity indicator. This will evolve into the full mission dashboard.
 */
export default function HomePage() {
  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center gap-10 p-6">
      ...
      {/* ── Status Card ───────────────────────────────────────── */}
      <Card className="w-full max-w-sm border-border/60 bg-card/50 backdrop-blur-md shadow-xl">
